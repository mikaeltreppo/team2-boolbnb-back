                   ...
                   <div class="d-flex flex-wrap">
                       ...
                       <div class="p-3 w-25">
                           ...
                           <input type="number" class="form-control @error('bathrooms') is-invalid @enderror"
                               id="bathrooms" name="bathrooms" min="1" max="130" step="1"
                       ...
                       <div class="p-3 w-25">
                           ...
                           <input type="number" class="form-control @error('size_m2') is-invalid @enderror"
                               id="size_m2" name="size_m2" min="1" max="130" step="1"
                               value="{{ old('size_m2') }}" required>
                   ...
                   <div>
                       @foreach ($facilities as $facility)
                           <div class="p-3">
                               ...
                               <input class="text" type="checkbox" id="facility_{{ $facility->id }}"
                                   name="facility_id[]" role="switch" @if (old('visible')) checked @endif
                                   value="{{ $facility->id }}">
                           </div>
                       @endforeach

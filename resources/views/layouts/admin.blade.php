...
<body>
    <div id="app">
        ...
        <main class="d-flex">
            <!--barra di navigazione laterale ( sentitevi liberi di cambiare il layout),l'ho messa solo per utilizzo, è brutta ma utile -->
            <div class="">
                <div class=" rounded d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;">
                    <a href="/admin"
